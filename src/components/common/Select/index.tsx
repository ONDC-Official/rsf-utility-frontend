...
const Select: FC<ICustomSelectProps> = ({ label, options = [], renderValue, formControlProps, ...props }) => (
  <StyledFormControl size={props.size} {...formControlProps}>
    {label && <InputLabel>{label}</InputLabel>}
    <MUISelect displayEmpty={props.displayEmpty} renderValue={renderValue} {...props}>
      {options.map((option) => (
