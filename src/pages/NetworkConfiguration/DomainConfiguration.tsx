...
const DomainConfiguration = ({ register, errors, role, setValue, watch, selectedUser }: IDomainConfigurationProps) => {
  ...
  return (
    <ConfigurationBox>
      ...
      <DomainConfigContainer>
        <ConfigHeader style={{ gridColumn: '1 / -1' }}>Domain Configuration</ConfigHeader>
        <FormContainer>
          <div>
